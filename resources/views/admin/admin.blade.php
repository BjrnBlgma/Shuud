    ...
    <section class="panel important">
        <form action="" method="GET" name="listForm" class="form scrollX">
            <div class="formHeader row">
                <h2 class="text-1 fl">Список новостей</h2>
                <div class="fr">
                    <button type="submit" class="btnSave bg-1 text-fff text-bold fr">Сохранить</button><a href="" class="btnAdd fa fa-plus bg-1 text-fff"></a>
                </div>
            </div>
                ...
                <ul>
                    ...
                    <li class="row" id="site-content">
                        ...
                        <div class="cell cell-100 text-center">
                            ...
                            <a href=""><img src="{{asset('storage/' . $images->image)}}" alt="" width="50"></a>
                            @endforeach
                        </div>
                        @endif
                        <div class="cell cell-100p"><a href="">{{ $post->title }}</a></div>
                        <div class="cell cell-100p"><a href="">{{$post->user->surname ?? ''}} {{$post->user->name ?? ''}}</a></div>
                        ...
                        <div class="cell cell-100 text-center">
                            ...
                            <a href="{{ route('delete-post', $post->id) }}" class="btnRemove fa fa-remove bg-1 text-fff" onclick='return confirm("Do you really want to remove it ?")'></a>
                        </div>
                    </li>
                    @endforeach
