...
<main role="main" id="site-content">
            ...
            <div class="table" id="site-content">
                ...
                <ul>
                    ...
                    <li class="row" id="site-content">
                        ...
                        <div class="cell cell-100 text-center">{{$post->post_types->name ?? 'Тип не задан'}}</div>
                        <div class="cell cell-100 text-center">
                            <a href=""><img src="{{ asset('storage/' . $post->images->first()->image) }}" alt="" width="50"></a>
                        </div>
    ...
    <section class="panel important">
        ...
        <form action="" method="post">
            ...
            <div class="twothirds">
                Тип поста:<br/>
                <label for="postTypeId" class="form-label"></label>
